...
import { PAIRING_DIGEST_HEX, AGENT_PRIVATE_HEX, AGENT_PUBLIC_HEX, BRAIN_PRIVATE_HEX, BRAIN_PUBLIC_HEX, APP_PAYLOAD, APP_REPLY } from '../web/fixture.mjs';
...
async function exchange(role) {
  const SnowSession = await loadWasm(); const binding = fromHex(PAIRING_DIGEST_HEX); const prologue=sessionPrologue(binding);
