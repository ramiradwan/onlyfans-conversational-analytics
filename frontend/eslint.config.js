...
export default [
  ...
  {
    files: [".design-sync/**/*.{ts,tsx}"],
    languageOptions: {
      parser: tsParser,
      parserOptions: {
        tsconfigRootDir: import.meta.dirname,
        project: ["./.design-sync/tsconfig.json"],
        ecmaVersion: 2021,
        sourceType: "module",
      },
      globals: {
  ...
  },
  {
    ...
    files: ["src/theme/{generate-theme,intent-contracts,color-validation,chart-qualification,token-consumers}.ts"],
    rules: {
